...
<body>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/s/bootstrap.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/myPage.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/answer_btn.js"></script>
		...
		<h2><b>Q/A</b></h2>
			<div>
				<table  cellpadding="0" cellspacion="0" class="QAwrite_table">
					...
					<form action = "qa_modify" method="post" >
						...
						%>
								...
								<a href="qa_delete?qId=${content_view.qId }">삭제</a> &nbsp;&nbsp;
						<%
								}
								if(isad.equals("1")) {
						%>
				...
				<h2><b>답변 작성</b></h2>
					<table  cellpadding="0" cellspacion="0" class="QAwrite_table">
						<form action = "qa_answer" method="post">
			...
			<!-- 이전 글 다음글 페이징 처리 다시 해야됨 -->
				<ul class="pagination">
					<li><a href="qacontent_view?bId=<%=qid -1%>" class="bt"> &lt;  </a> </li>
