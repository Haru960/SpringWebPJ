...
<head>
<meta charset="UTF-8">
<link href="${pageContext.request.contextPath}/resources/css/css_slide.css?v=3"
...
<body>
	...
	<div class="middles">
		...
		<div class="mySlides fade">
		  ...
		  <img src="${pageContext.request.contextPath}/resources/img/slide_1.png"  width="100%" height="465px">
		  <!-- <div class="text">Caption Text</div> -->
		</div>
		
		<div class="mySlides fade">
		  <div class="numbertext">2 / 3</div>
		  <img src="${pageContext.request.contextPath}/resources/img/slide2.png"  width="100%" height="465px">
		 <!--  <div class="text">Caption Two</div> -->
		</div>
		
		<div class="mySlides fade">
		  <div class="numbertext">3 / 3</div>
		  <img src="${pageContext.request.contextPath}/resources/img/slide3.png"  width="100%" height="465px">
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/mySlide.js" charset="UTF-8"></script>
	</div>
	<div>
