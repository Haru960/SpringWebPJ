...
<body>
	...
	<div class="grid_container">
		...
		<div class="search">
			<form class="table-from" action="bcontent_view?PN=<%= 1 %>" method="get">
		...
		<h2><b>자료실</b></h2>
			<table cellpadding="10" cellspacion="0" class="write_table">
				...
				<form action="modify" method="post" >
					...
					%>
						...
						<td> <a href="file_Down?bId=<%=bid %>&fileRealName=<%=fdto.getFileRealName()%>"><%=fdto.getFileRealName()%> 다운로드</a> </td>
					<%
						}
					%>
					</tr>
			...
			<%-- <div class="paging">
				<ul class="pagination">
					...
					<li><a href="bcontent_view?bId=<%=bid -1%>" class="bt"> &lt;  </a> </li>
						
					
					
					<li><a href="bcontent_view?bId=<%=bdto.getbId() +1%>" class="bt"> &gt; </a> </li>
