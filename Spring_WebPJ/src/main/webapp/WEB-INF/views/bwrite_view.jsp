...
<body>
	...
	<div class="grid_container">
		...
		<h2><b>자료실</b></h2>
			<table cellpadding="0" cellspacion="0" class="write_table">
				<form action="write" method="post" enctype="multipart/form-data">
					<tr hidden="">
						<td> 이름 </td>
						<td> <input type="text" name="bName" size="20" value="<%=session.getAttribute("name")%>" > </td>
					</tr>
					<tr hidden="">
						<td> 작성자 </td>
					...
					<tr>
						<td colspan="2"> <input type="text" id="bTitle_input" name="bTitle" size="50" placeholder="제목을 입력해 주세요" width="500px"> </td>
					</tr>
					<tr>
						<td colspan="2"> <textarea name="bContent" id="bContent_input" rows="10" placeholder="내용을 입력해 주세요"></textarea></td>
					</tr>
					<tr>
						<td>파일</td>
